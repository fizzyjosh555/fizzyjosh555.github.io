    ...
    render() {
        return (
            <div className="socialLinks">
                <div><a className="hvr-icon-shrink" href="https://www.linkedin.com/in/joshua-yun-9709b0170/" rel="noopener noreferrer" target="_blank"><img className="hvr-icon" style={{maxWidth:"26px"}} src={linkedin} alt="https://www.linkedin.com/in/joshua-yun-9709b0170/"></img></a></div>
